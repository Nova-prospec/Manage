...
const Footer = () => {
    ...
    const handleClick = (e) => {
        let text = e.target.parentElement.parentElement.querySelector("input")
            ...
            <div className="footer-end">
                <div className="email-div">
                    <div>
                       ...
                       <input onChange={handleChange} type="text" value={input} placeholder="johnmadden/email" />
                        {error == true &&  <span>Please enter a valid email</span>}
                       </div>
